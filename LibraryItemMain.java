...
public class LibraryItemMain {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Aprajita's Library, Charlotte !");
        ...
        // Initializing the contructor classes.
        CardHolder cholder = new CardHolder(null, null, null, null, null, null, 0, 0.0);
        List<CardHolder> cardholderarray = new ArrayList<>();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter your id...");
        cardid = scanner.next();
        System.out.println("Please enter your name...");
        cardname = scanner.next();
        System.out.println("Please enter your book name which you want to checkout...");
        cardbook = scanner.next();
        cholder = new CardHolder(cardid, cardname, cardbook, null, null, null, 0, 0.0);
        cardholderarray.add(cholder);
        System.out.println("Book " + cardbook + " has been checked out successfully to you!");
        System.out.println("Book is due on : " + "and number of days before due is : ");
    }
}